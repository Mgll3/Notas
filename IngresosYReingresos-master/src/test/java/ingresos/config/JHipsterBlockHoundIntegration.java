...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ingresos.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ingresos.security.DomainUserDetailsService", "createSpringSecurityUser");
