...
/**
 * REST controller for managing {@link ingresos.domain.Estudiante}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EstudianteResource {
    ...
    private static final String ENTITY_NAME = "modulo3IyREstudiante";
            ...
            .flatMap(exists -> {
                ...
                Mono<Estudiante> result = estudianteRepository
                    ...
                    .map(existingEstudiante -> {
                        if (estudiante.getDiligenciado() != null) {
                            existingEstudiante.setDiligenciado(estudiante.getDiligenciado());
                        }
